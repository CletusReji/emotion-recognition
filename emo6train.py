...
model = Sequential([
    ...
    Dropout(0.4),
    Dense(6, activation="softmax")  # 6 classes for emotion detection
])
...
checkpoint = ModelCheckpoint("emo6modelmid.keras", monitor="val_accuracy", save_best_only=True, mode="max")
